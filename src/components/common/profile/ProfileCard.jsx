      ...
      <Row className=" border border-[#FDCED5] rounded-2xl">
        <Col span={6}>
          <div className="h-[460px]">
            <Image
              className="!h-[460px] !w-full !object-cover rounded-tl-xl rounded-bl-xl"
              preview={false}
              src={profileImage}
            />
          </div>
        </Col>
        <Col span={16} className="ps-10 py-4 ">
          <div className="flex flex-col gap-[12px] ">
            <div className="flex flex-col  ">
              <div className="relative flex gap-2 items-center">
                ...
                <div
                  className="absolute -right-25 top-0 ps-[40px] pe-[34px] rounded-l-full py-[10px] flex gap-[36px] items-center"
                  style={{
                    background:
              ...
              <div className="flex items-center gap-2  ">
                <CustomText
                  ...
                  className={"!text-[12px] !font-[300] text-[#444]"}
                />
            ...
            <div className="relative flex flex-col gap-[10px] ">
              ...
              <div
                className="absolute -left-10 -bottom-11 ps-[40px] pe-[34px] rounded-r-full py-[5px]"
                style={{
                  background:
                    "linear-gradient(270deg, #E24A9A 0%, #F81B3E 100%)",
                }}
